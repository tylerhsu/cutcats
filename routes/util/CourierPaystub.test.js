...
describe('CourierPaystub', function() {
  ...
  describe('this.getToCC()', function() {
    ...
    it('when ride\'s client has deliveryFeeStructure == "on demand food", returns 25% of ride fee rounded down', function() {
      ...
      this.courierPaystub.getToCC(rides[0]).should.eql(0);
      this.courierPaystub.getToCC(rides[1]).should.eql(1);
      this.courierPaystub.getToCC(rides[2]).should.eql(1);
      this.courierPaystub.getToCC(rides[3]).should.eql(2);
    });

    it('when ride\'s client has deliveryFeeStructure == "legacy on demand food", returns 25% of ride fee rounded down', function() {
    ...
    it('when ride\'s client has deliveryFeeStructure == "catering food", returns 25% of ride fee rounded down', function() {
    ...
    it('when ride\'s client has deliveryFeeStructure == "cargo/wholesale/commissary", returns 12% of ride fee rounded down', function() {
      ...
      this.courierPaystub.getToCC(rides[0]).should.eql(0);
      this.courierPaystub.getToCC(rides[1]).should.eql(0);
      this.courierPaystub.getToCC(rides[2]).should.eql(0);
      this.courierPaystub.getToCC(rides[3]).should.eql(1);
    });
